...
class CurvePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (colors != null) {
      ...
      list.addAll([Colors.white, Colors.white]);
    }
    ...
    final centerSd = Offset(size.width / 2, size.height / 2);
    final radiusSd = min(size.width / 2, size.height / 2) - (14 / 2);
    canvas.drawArc(
        Rect.fromCircle(center: centerSd, radius: radiusSd),
        degreeToRadians(278),
